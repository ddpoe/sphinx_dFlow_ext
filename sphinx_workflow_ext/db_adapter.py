...
class DatabaseAdapter:
    ...
    def list_modules(self) -> List[ModuleData]:
        ...
        # Import tables from generate_workflow_docs
        try:
            from generate_workflow_docs.db.tables import Module
        except ImportError:
    ...
    def get_module_workflow(self, module_path: str) -> Optional[WorkflowData]:
        ...
        try:
            from generate_workflow_docs.db.tables import Module, Function, Step
        except ImportError:
            import sys
            sys.path.insert(0, str(self.project_root.parent))
            from generate_workflow_docs.db.tables import Module, Function, Step
