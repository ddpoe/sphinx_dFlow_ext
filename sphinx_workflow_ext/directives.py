...
class WorkflowDirective(Directive):
    ...
    def run(self) -> List[nodes.Node]:
        ...
        try:
            from generate_workflow_docs.extractors.multi_tier_module_extractor import MultiTierModuleExtractor
            from generate_workflow_docs.core import ExtractorConfig
            from generate_workflow_docs.processing.hierarchy_builder import StepHierarchyBuilder
...
class WorkflowNotebookDirective(Directive):
    ...
    def run(self) -> List[nodes.Node]:
        ...
        # Import extractor
        try:
            from generate_workflow_docs.extractors import NotebookWorkflowExtractor
            from generate_workflow_docs.core import ExtractorConfig
